---
title: "小八 on X: "从零开始两天构建一个 Claude Code：带你拆解 AI CLI 的每一层" / X"
source: "https://x.com/IceBearMiner/status/2037888800341610684"
saved_at: "2026-03-29"
tags: ["Claude", "X/Twitter"]
---

# 小八 on X: "从零开始两天构建一个 Claude Code：带你拆解 AI CLI 的每一层" / X

Title: 小八 on X: "从零开始两天构建一个 Claude Code：带你拆解 AI CLI 的每一层" / X

URL Source: https://x.com/IceBearMiner/status/2037888800341610684

Published Time: Sun, 29 Mar 2026 13:52:43 GMT
...
[![Image 1: Image](./img_0cc768f3.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037872756122124288)
...
[![Image 2: Image](./img_33b87195.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037885702487293952)
...
[![Image 3: Image](./img_146a84b4.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037885799392489472)
...
[![Image 4: Image](./img_2466b6e8.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037885835367088128)
...
[![Image 5: Image](./img_0d14ee17.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037885870423044096)
...
协议层 是 JSON-RPC 2.0 over stdio：启动 MCP server 进程，通过 stdin/stdout 交换 JSON-RPC 消息。启动序列固定：initialize 握手 → tools/list 获取工具定义数组。工具定义包含 JSON Schema 格式的 inputSchema，与 Anthropic API 的工具格式直接兼容。McpManager 管理多个 server 的生命周期，工具名加上 mcp server_name 前缀做命名空间隔离。

LSP 集成 解决不同的问题：不是扩展工具，而是给模型提供实时的代码诊断信息。LspClient 实现 Language Server Protocol 客户端侧，使用 Content-Length 帧协议通信。LspManager 维护文件扩展名到语言服务器的路由表，Write/Edit 执行后自动通知对应语言服务器，诊断结果作为 lsp_diagnostics section 注入下一轮 system prompt。

这个设计让模型在修改代码后能立即看到编译器反馈，而不需要单独的"检查错误"工具调用，缩短了发现问题到修复问题的路径。

[![Image 6: Image](./img_21e6da85.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037886235193344000)
...
![Image 7: Article cover image](./img_29922945.jpg)

龙虾Token焦虑？深度拆解我基于Pimono二开的openclaw与如何节省token

事先声明，本篇文章ai覆盖率大概在10%，大部分纯手写，部分配图取自于ai，手写只是为了自驱型学习，其他平台都是用ai居多。项目则是100%的ai编写，没有一行古法编排，介意勿扰 缺Token必看：codex-proxy 项目介绍...
...
[![Image 8: Image](./img_33e6558f.jpg)](https://x.com/IceBearMiner/article/2037888800341610684/media/2037887154647638016)
